        ...
        <div class="lg:hidden">
            ...
            <div class="mt-7 p-3">
                ...
                <p class="text-lg text-left text-gray-700 pl-0 p-2" data-aos="fade-right" data-aos-delay="800">
                    Photoshoto is a social media site where you can upload photos and make a battle between them. You
                    can battle with DP by making a post. Other users can like or comment on posts and create most liked
            ...
            <div class="mt-7 p-3 mb-7">
                ...
                <div class="grid grid-cols-4 md:grid-cols-7  md:gap-16 gap-8 px-4 mt-5 ">
                    <img class="py-3 w-12" title="Tailwindcss" src="storage/images/Tailwindcss.svg" alt="Tailwindcss"
                    ...
                    <img class="w-12" title="Alpinejs" src="storage/images/Alpinejs.png" alt="Alpinejs" data-aos="fade"
                        data-aos-delay="600">
