<div class="lg:hidden">
    ...
    <div class="py-14 text-white text-center p-2 pb-9 " style="background-color: #121212;">
        <h1 class="text-3xl font-semibold" data-aos="fade">Projects</h1>
        <p class="text-xl py-4 " data-aos="fade">In-depth Case Studies to show you what I can offer and how I work
        </p>
    </div>

    <section class="gallery p-1 py-5 pb-9 w-10/12 mx-auto" x-data="{ tab: 'all' }">
        <div class="sort" data-aos="fade" data-aos-delay="100">
            <ul class="sort-links">
                <li class="link-item">
        ...
        <div class="grid md:grid-cols-2  sm:grid-cols-2 grid-cols-1 gap-4 px-4 mt-9 ">

            <div x-show="tab === 'all' || tab === 'PHP' || tab=='Javascript'" data-aos="fade-up">
            ...
            <div x-show="tab === 'all' || tab === 'PHP' || tab=== 'Javascript'" data-aos="fade-up">
                ...
                <div class="zoom rounded text-gray-200 hover:text-white  shadow-lg flex flex-col  mt-10 mb-3 mx-auto"
                    style="background-color:#121212">
                    ...
                    <div class="mx-auto m-2">
                        <div class="flex  flex-col text-center ">
                            <a href="{{ ('/KeshavMahavidyalaya') }}" class="hover:underline text-lg font-medium">My
                                College Site</a>
                            <a href="{{ ('/KeshavMahavidyalaya') }}"avMahavidyalaya.html" class="hover:underline text-sm ">Keshav
                                Mahavidyalaya</a>
                        </div>
                    </div>
                    <div class="py-1.5 mx-auto  pb-5 text-sm">
            ...
            <div x-show="tab === 'all' || tab === 'PHP' || tab === 'Javascript' || tab ==='Laravel'" data-aos="fade-up">
                <div class="zoom rounded text-gray-200 hover:text-white  shadow-lg flex flex-col  mt-10 mb-3 mx-auto"
                    style="background-color:#121212">
                    <video id="inlineVideo" class="rounded" width="100%" controls="controls"
