    ...
    <div>
        <div class="lg:hidden">
            <div class="py-14 text-white text-center p-2 pb-9 " style="background-color: #121212;">
                ...
                <p data-aos="fade" class="text-xl py-4 ">P.P.S.V.M.Inter College Nanakmatta U.S.Nagar, Uttarakhand [Pin
                    Code
                    : 262405]
                </p>
            ...
            <div class="mt-7 p-3">
                ...
                <p class="text-lg text-left pl-0 p-2">
                    ...
                    <ul class="list-disc mx-auto pl-3 w-11/12 text-gray-700" data-aos="fade-right" data-aos-delay="800">
                        ...
                        <li class="mt-2">Accessibility with mobile devices, since most visitors nowadays use a mobile
            ...
            <div class="mt-7 p-3 mb-7">
                ...
                <div class="grid grid-cols-4 md:grid-cols-7  md:gap-16 gap-8 px-4 mt-5 ">
                    ...
                    <img class="py-3 w-12" title="PHP" src="storage/images/PHP.svg" alt="PHP" data-aos="fade"
                        data-aos-delay="400">
                    <img class="w-12" title="Javascript" src="storage/images/JS.svg" alt="Javascript" data-aos="fade"
                        data-aos-delay="600">
            ...
            <div class="py-24 pb-10" style="background-color: #121212;">
                <div class="flex justify-between w-10/12 pl-2 mx-auto ">
                    <div>
                        ...
                        <p class="text-xl py-4 text-white" data-aos="fade">P.P.S.V.M.Inter College Nanakmatta U.S.Nagar,
                            Uttarakhand [Pin Code : 262405]
                        </p>
                        <a href="https://github.com/manojbhatt101010/ppsvmic.git">
                            <button id="socialbtn"
                                class="text-white  shadow-lg  pr-3  focus:outline-none  rounded p-1.5 " data-aos="fade">
                ...
                <div class="grid mx-auto lg:grid-cols-5 w-9/12 mt-7">
                    ...
                    <div class="flex">
                        <img class="w-12 mr-9" title="Bootstrap4" src="storage/images/Bootstrap.svg" alt="Bootstrap"
                            data-aos="fade" data-aos-delay="200">
                        <img class="w-16 py-2 mr-9" title="PHP" src="storage/images/PHP.svg" alt="PHP" data-aos="fade"
                            data-aos-delay="400">
                        <img class="w-12 mr-9" title="Javascript" src="storage/images/JS.svg" alt="Javascript"
                            data-aos="fade" data-aos-delay="600">
                        <img class="w-12 mr-9" title="HTML5" src="storage/images/HTML.svg" alt="HTML5" data-aos="fade"
                            data-aos-delay="800">
                        <img class="w-12 mr-9" title="CSS3" src="storage/images/CSS.svg" alt="CSS3" data-aos="fade"
                            data-aos-delay="1000">
                        <img class="w-12 mr-8" title="MySQL" src="storage/images/MySQL.svg" alt="MySQL" data-aos="fade"
                            data-aos-delay="1200">
